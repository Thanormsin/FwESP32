...
const char* ssid = "MY_HOME";                                            //Set your WiFi network name and password
...
void setup() 
{
  ...
  wifiMulti.addAP("MY_HOME", "0819065291");
...
void loop() 
{
  ...
  {
    payload = getPrice("BTCUSDT"); //HTTP
    percent = getChangePercent("BTCUSDT");
    
    Serial.print("BTCUSDT : ");
...
//////////////////////////////////////////////////////
  ...
  if (percent>=0)                                                                             //If price has increased from yesterday
  {
  ...
  printCenter("BTCUSDT", 0, 0);                                                         //Display the comparison header

  display.setTextSize(2);
  printCenter("$" + String(payload), 0, 25);
  //printCenter("$" + String(payload), 0, 25);                                                //Display the current price
...
//    payload = getPrice("ETHUSDT"); //HTTP
//    percent = getChangePercent("ETHUSDT");
    
//    Serial.print("ETHUSDT : ");
//    Serial.print(payload);
//    Serial.print(" : ");
//    Serial.print(percent);
//    Serial.println("%");
...
float getPrice(String coin)
{
  String url = "https://api.binance.com/api/v3/ticker/24hr?symbol="+coin;
  ...
  float price = obj[String("lastPrice")];

  return price;
}

float getChangePercent(String coin)
{
  String url = "https://api.binance.com/api/v3/ticker/24hr?symbol="+coin;
  ...
  float price = obj[String("priceChangePercent")];
