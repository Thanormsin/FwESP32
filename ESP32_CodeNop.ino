...
const char* ssid1     = "Tha3-2.4G";        //<-- ใส่ชือ Wifi หลัก
const char* password1 = "0819065291";         //<-- ใส่รหัส Wifi หลัก ตรงนี

const char* ssid2     = "Tha4-2.4G";        //<-- ใส่ชือ Wifi รอง ตรงนี ถ้าใช้ WiFi ตัวเดียวก็ให้ใส่เหมือนกันกับ ssid1
...
const char* ssid     = "Tha3-2.4G";            // Change this to your WiFi SSID
const char* password = "0819065291";           // Change this to your WiFi password

String ducouser = "";          // Change this to your Duino-Coin username
...
String BrdNm    = "Nop-04";             //<-- ใส่ชือ RigName ตรงนี
...
#define URL_fw_Version "https://raw.githubusercontent.com/Thanormsin/FwESP32/master/bin_version32Nop.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/Thanormsin/FwESP32/master/fw_32Nop.bin"
