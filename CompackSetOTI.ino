...
#define URL_fw_Version "https://raw.githubusercontent.com/Thanormsin/FwESP32/main/CompackSet_bin.txt"
#define URL_fw_Bin     "https://raw.githubusercontent.com/Thanormsin/FwESP32/main/CompackSetOTI.bin"
...
//  //### WDT ##################
  ...
  //ArduinoOTA.setHostname("CompacksetOTA");
...
//  }
  ...
  for (int i = 15; i > 7; i--)
  {
    //Serial.println(MCP0_B[i]);
    //mcp.digitalWrite(MCP0[i], HIGH);
    mcp1.digitalWrite(MCP1[i], HIGH);
    //mcp2.digitalWrite(MCP2[i], HIGH);
    //mcp3.digitalWrite(MCP3[i], HIGH);
    delay(200);
  }
  ...
  for (int i = 15; i > 7; i--)
  {
    ...
    //mcp.digitalWrite(MCP0[i], LOW);
    mcp1.digitalWrite(MCP1[i], LOW);
    //mcp2.digitalWrite(MCP2[i], LOW);
    //mcp3.digitalWrite(MCP3[i], LOW);
    delay(200);
  }
